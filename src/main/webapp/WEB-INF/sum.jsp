...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong><strong>/</strong><small>收支总览</small> </div>
    </div>
        ...
        <pre class="am-pre-scrollable">
         <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              <tbody>
              <tr>
                <th class="am-text-center">收入支出</th>
              ...
              %>       
             <tr class="am-active">
                 <td class="am-text-center">${bill.account.type}</td>
               ...
               <%}else{
            	   a=true;%>
                <tr class="am-success">
                 <td class="am-text-center" style="color: black">${bill.account.type}</td>
              ...
              <tr class="am-danger">
                  <%   double sum = 0;
                      ...
                      for (int i = 0; i < list.size(); i++) {
                          if(list.get(i).getAccount().getType().equals("收入")) {
                  ...
                  %>
                <td class="am-text-center" style="color: black"> 收支总计</td>
                <td class="am-text-center" style="color: black" ><%=sum%></td>
