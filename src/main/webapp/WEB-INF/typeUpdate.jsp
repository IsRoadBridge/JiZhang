...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页/</strong><small>账目类别修改</small> </div>
    </div>

    <div class="am-btn-group am-btn-group-xs">
    <a type="button" class="am-btn am-btn-default" href="typeAdd"><span class="am-icon-plus"></span> 新增</a></div>
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped am-table-hover  admin-content-table" style="text-align: center">
          ...
          <c:forEach var="account" items="${all}" varStatus="it">           
           <tr>
               <td>${it.count}</td>
               <td>${account.type}</td>
               <td>${account.smallType}</td>
              <td>
              <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="typeUpdateDo?id=${account.accountId} " style="color: #46A3FF"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                    <a class="am-btn am-btn-default am-btn-xs" href="#" onclick="del(${account.accountId})" style="color: #EA0000"><span class="am-icon-trash-o" ></span> 删除</a>
                  </div>
                </div>
            </td>
