...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong><strong>/</strong><small>收入总览</small> </div>
    </div>
        ...
        <pre class="am-pre-scrollable">
         <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              <tbody>
              <tr>
                <th class="am-text-center">收入类型</th>
             ...
             <tr class="am-active">
              ...
              <tr class="am-danger">
                  ...
                  %>
                <td class="am-text-center" style="color: black"> 总收入</td>
