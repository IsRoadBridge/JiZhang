...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong><strong>/</strong><small>添加账目</small> </div>
    </div>
   
    <div class="am-u-sm-12 am-u-md-8 ">
        <form class="am-form am-form-horizontal" action="billInsert" method="get" onsubmit="return check()">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="money" placeholder="金额" name="money">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="money-mouse" placeholder="消费说明" name="remarks">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="pay" placeholder="支付方式" name="pay">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="date" id="date" placeholder="日期" name="date">
            </div>
          </div>

          <div class="am-form-group" style="margin-left: 400px;">
            <div class="am-u-sm-9 ">
              <button type="submit" class="am-btn am-btn-success" >确认提交</button>
            </div>
          </div>
        </form>
      </div>
