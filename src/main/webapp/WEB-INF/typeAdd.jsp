...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong><strong>/</strong><small>添加账目类型</small> </div>
    </div>
   
    <div class="am-u-sm-12 am-u-md-8 ">
        <form class="am-form am-form-horizontal" action="typeAddDo" method="get" onsubmit="return check()">
          <div class="am-form-group">
            <label for="account-type" class="am-u-sm-3 am-form-label">账目类型</label>
            <div class="am-u-sm-9">
             <!--   <input type="text" id="acount-type" name="type" placeholder="账目类型">-->
             <select name="type" id="acount-type">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="son-class" placeholder="子分类" name="smallType">
